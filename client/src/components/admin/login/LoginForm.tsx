...
export default function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md rounded-lg bg-primary-200 px-8 py-10 shadow-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full rounded bg-primary-600 px-4 py-2 font-semibold text-white transition duration-200 hover:bg-primary-700 focus:outline-none focus:ring focus:ring-primary-500"
        >
          로그인
        </button>
      </form>
